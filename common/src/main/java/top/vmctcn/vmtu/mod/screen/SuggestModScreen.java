...
public class SuggestModScreen extends Screen {
    ...
    protected void init() {
        ...
        this.addButton(new ButtonWidget(centerX - 5 - 150, this.height - (FOOTER_HEIGHT / 2) - 10, 150, 20, ModContexts.ScreenTexts.downloadButton, buttonWidget -> {
        ...
        this.addButton(new ButtonWidget(centerX + 5, this.height - (FOOTER_HEIGHT / 2) - 10, 150, 20, ModContexts.ScreenTexts.ignoreButton, buttonWidget -> this.onClose()));
    }
