...
public class SuggestModScreen extends Screen {
    ...
    protected void init() {
        ...
        this.addButton(new ButtonWidget(centerX - 155, this.height - 38, 150, 20, downloadButtonText, buttonWidget -> {
        ...
        this.addButton(new ButtonWidget(centerX - 155 + 160, this.height - 38, 150, 20, ignoreButtonText, buttonWidget -> this.onClose()));
    }
