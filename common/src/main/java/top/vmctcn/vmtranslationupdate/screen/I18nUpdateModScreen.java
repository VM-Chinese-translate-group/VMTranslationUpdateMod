...
public class I18nUpdateModScreen extends Screen {
    public final Screen lastScreen;
    private static final MutableText warnScreenText = Text.translatable("vmtranslationupdate.warn.i18nupdatemod.text");
    private final String modrinthUrl = "https://modrinth.com/mod/i18nupdatemod";
    ...
    public I18nUpdateModScreen(Screen lastScreen) {
        super(Text.translatable("vmtranslationupdate.warn.i18nupdatemod.title").formatted(Formatting.RED).formatted(Formatting.BOLD));
