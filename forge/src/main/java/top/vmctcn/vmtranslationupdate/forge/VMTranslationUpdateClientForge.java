...
public class VMTranslationUpdateClientForge {
    public VMTranslationUpdateClientForge() {
        ...
        context.registerExtensionPoint(ConfigGuiHandler.ConfigGuiFactory.class, () -> new ConfigGuiHandler.ConfigGuiFactory((client, screen) -> AutoConfig.getConfigScreen(ModConfigs.class, screen).get()));
